              ...
              {currentView === 'more' && (
                <div className="animate-slide-up ios-glass rounded-[3rem] p-10 flex flex-col space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <button onClick={() => window.open('https://namaz.muftyat.kz', '_blank')} className="flex items-center justify-between p-6 rounded-[2.2rem] bg-white/5 border border-white/5 w-full hover:bg-white/10 active:scale-[0.97] group animate-slide-up" style={{animationDelay: '200ms'}}>
